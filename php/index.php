...
HTML;
    ...
    echo '<style>.metrics b.uv-low{color:#A78BFA}.metrics b.uv-moderate{color:#8B5CF6}.metrics b.uv-high{color:#7C3AED}.metrics b.uv-very-high{color:#5B21B6}.metrics b.uv-extreme{color:#4C1D3D}</style>';
